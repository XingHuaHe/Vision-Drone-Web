...
def train(hyp, opt, device, tb_writer=None):
    ...
    last = wdir + 'last_sparsity.pt'
    # best = wdir + 'best_sparsity.pt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='E:/PythonPrograms/VisDrone-Object-Detection/YOLOv4-SKCS/weights/***.pt', help='initial weights path or pre-training model state dict (.pt/.pth)')
    parser.add_argument('--cfg', type=str, default='./cfg/yolov4-spk-spp.cfg', help='model .cfg file path')
    ...
    parser.add_argument('--name', default='yolov4-anchor-sparsity', help='renames results.txt to results_name.txt if supplied')
