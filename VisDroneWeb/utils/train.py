...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        model = Darknet(opt.cfg, img_size=opt.img_size).to(device)  # create
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if save:
                ...
                # elif (best_fitness == fi) and not final_epoch:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./cfg/yolov4-spk-spp.cfg', help='model.yaml path')
    ...
    parser.add_argument('--name', default='yolov4-spk-spp', help='renames results.txt to results_name.txt if supplied')
